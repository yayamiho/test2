...
<div class="card mb-3" style="clear:both;">
    <div class="card-body">
        <div class="row mb-2 no-gutters">
            <div class="col-md-2"><h5 class="mb-0">User</h5></div>
            <div class="col-md-10">{!! $submission->user->displayName !!}</div>
        </div>
        @if($submission->prompt_id)
            <div class="row mb-2 no-gutters">
                <div class="col-md-2"><h5 class="mb-0">Prompt</h5></div>
                <div class="col-md-10">{!! $submission->prompt->displayName !!}</div>
            </div>
        @endif
        <div class="row mb-2 no-gutters">
            <div class="col-md-2"><h5 class="mb-0">URL</h5></div>
            <div class="col-md-10"><a href="{{ $submission->url }}">{{ $submission->url }}</a></div>
        </div>
        <div class="row mb-2 no-gutters">
            <div class="col-md-2"><h5 class="mb-0">Submitted</h5></div>
            <div class="col-md-10">
        ...
        @if($submission->status != 'Pending' && $submission->status != 'Draft')
            <div class="row mb-2 no-gutters">
                <div class="col-md-2"><h5 class="mb-0">Processed</h5></div>
                <div class="col-md-10">
